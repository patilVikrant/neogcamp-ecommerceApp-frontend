...
const ProductDetails = () => {
  ...
  const requiredBook = books.find((book) => book._id == id);
  //   console.log(requiredBook);
  const isAddedToCart = cartItems.find((book) => book._id == id);
  const isBookAddedToWishlist = wishlistItems.find((book) => book._id == id);
